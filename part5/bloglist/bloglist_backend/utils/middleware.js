...
// Exercise 4.21: Extracting token from the Authorization header
...
const userExtractor = async ( request, response, next ) => {
  ...
  const decodedToken = jwt.verify(token, process.env.SECRET) // Verify the token and decode it to get the user information
  if (!decodedToken.id) {
